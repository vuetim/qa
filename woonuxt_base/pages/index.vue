...
<template>
  <main>
    <HeroBanner />
    <!-- Features -->
    <section class="hidden container xl:grid xxl:grid 2xl:grid gap-4 my-20 md:grid-cols-2 lg:grid-cols-4">
    ...
    <!-- Features -->
    <section class="container xl:hidden xxl:hidden 2xl:hidden sm:grid gap-4 my-20 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <NuxtImg src="/icons/box.svg" width="60" height="60" alt="Free Shipping" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">Free Shipping</h3>
